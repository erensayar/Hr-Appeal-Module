...
import static com.erensayar.HrWebApplicationApi.error.exception.ExceptionConstants.CONFLICT_ERROR_CODE;
import static com.erensayar.HrWebApplicationApi.error.exception.ExceptionConstants.CONFLICT_ERROR_MESSAGE;
