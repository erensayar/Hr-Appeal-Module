...
public final class ExceptionConstants {
    ...
    static final String CONFLICT_ERROR_CODE                   = "0003";
    ...
    static final String VALIDATION_ERROR_CODE                 = "0006";
    static final String VALIDATION_ERROR_MESSAGE              = "Not Valid Error";
